...
public:
    ...
    void CreateNewAlways(const std::wstring & fullname)
    {
        Open(fullname, GENERIC_WRITE, FILE_SHARE_READ|FILE_SHARE_DELETE, CREATE_ALWAYS);
    }
...
void CreateDir(const std::wstring & path, const char * pData = "Can't access directory");
