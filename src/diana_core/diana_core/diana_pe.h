...
// Flags:
#define DIANA_EXECUTABLE_FILE_FLAGS_MODULE_MODE     0
#define DIANA_EXECUTABLE_FILE_FLAGS_FILE_MODE       1

#define DIANA_PE_FILE_FLAGS_MODULE_MODE     DIANA_EXECUTABLE_FILE_FLAGS_MODULE_MODE
#define DIANA_PE_FILE_FLAGS_FILE_MODE       DIANA_EXECUTABLE_FILE_FLAGS_FILE_MODE
